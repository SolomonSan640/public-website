...
class AboutPageMmController extends Controller
{
    use ImageUploadTrait;
    public function index($country)
    {
        $this->setLocale(strtolower($country));
        $about = AboutPageMM::orderBy('updated_at', 'desc')->get();
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            ...
            $about = AboutPageMM::findOrFail($id);
    ...
    protected function getCreateData($request, $id)
    {
        ...
        $existingData = AboutPageMM::find($id);
