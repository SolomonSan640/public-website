...
use App\Filament\Resources\ServicePageMmResource\Pages;
...
class ServicePageMmResource extends Resource
{
    protected static ?string $model = ServicePageMM::class;
    ...
    {
        $recordCount = ServicePageMM::count();
        if ($recordCount < 1) {
            return true;
        } else {
            return false;
    ...
    {
        return [
            'index' => Pages\ListServicePageMms::route('/'),
            'create' => Pages\CreateServicePageMm::route('/create'),
            'view' => Pages\ViewServicePageMm::route('/{record}'),
            'edit' => Pages\EditServicePageMm::route('/{record}/edit'),
        ];
    }
}
