...
use App\Filament\Resources\EuropeResource\Pages;

class EuropeResource extends Resource
{
    ...
    protected static ?string $navigationLabel = 'Europe';
    ...
    {
        return [
            'index' => Pages\ListEuropes::route('/'),
            'create' => Pages\CreateEurope::route('/create'),
            'view' => Pages\ViewEurope::route('/{record}'),
            'edit' => Pages\EditEurope::route('/{record}/edit'),
        ];
    }

    public static function getEloquentQuery(): Builder
    {
        return parent::getEloquentQuery()->where('regional_id', '=', 4);
    }
}
