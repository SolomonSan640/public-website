...
return new class extends Migration
{
    ...
    {
        Schema::create('home_page_m_m_s', function (Blueprint $table) {
            $table->id();
            ...
            $table->longText('slider_content_4')->nullable();
            $table->longText('slider_content_5')->nullable();
            ...
            $table->string('slider_image_4')->nullable();
            $table->string('slider_image_5')->nullable();
            ...
            $table->string('image_m_6')->nullable();
            $table->string('image_m_7')->nullable();
            $table->string('image_m_8')->nullable();
            $table->string('image_m_9')->nullable();
            $table->string('image_m_10')->nullable();
    ...
    {
        Schema::dropIfExists('home_page_m_m_s');
    }
};
